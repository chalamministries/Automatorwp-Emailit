 ...
 * @since 1.0.0
 */
function automatorwp_mailpoet_ajax_get_forms() {
    ...
    $forms = automatorwp_mailpoet_get_forms( );
...
add_action( 'wp_ajax_automatorwp_mailpoet_get_forms', 'automatorwp_mailpoet_ajax_get_forms' );